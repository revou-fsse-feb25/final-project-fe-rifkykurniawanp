...
import { ButtonProps, CardProps, TabsProps, TabsListProps, TabsTriggerProps, TabsContentProps, AnimatedSectionProps, TeamMember, Feature, Stat } from "@/types/interface";
